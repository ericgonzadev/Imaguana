                    ...
                    <div class="row" >
                        <div class="col-sm-10 col-sm-offset-1">
                            <div class="modal-body" style="text-align: center;">                                    
                                ...
                                <br>
                                <input id="foo' . $image->data()->id . '" style="color:black; height: 40px; width: 510px; margin-left: -20px;" type="text" value="<img src=&quot;http://getenv('OPENSHIFT_MYSQL_DB_HOST')/~admin67KSwkr/' . $image->data()->image . '&quot; >" readonly name="source"><br>
