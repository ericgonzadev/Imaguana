        ...
        <div class="row">
            ...
            .multiPic:hover .text1{ 
                opacity:0.9; 
                    ...
                    <form action="/image/preview/<?php echo $image->data()->image; ?>" method="POST">
                ...
                <div class="ws-product-content">
                    ...
                    <header>
                        <div class="ws-product-details">
                            ...
                            <p style="margin-bottom: 15px;"><a style="margin-top: 4px; color: #0000EE;" href="<?php echo str_replace(' ', '', rawurldecode("user/" . $image->data()->username)); ?>" ><?php echo $image->data()->user . "&nbsp(" . $image->data()->username . "&nbsp)"; ?></a></p>
                            <!-- Description -->
