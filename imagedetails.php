                ...
                <div class="ws-product-content">
                    ...
                    <header>
                        <div class="ws-product-details">
                            ...
                            <p style="margin-bottom: 15px;"><a style="margin-top: 4px; color: #0000EE;" href="<?php echo str_replace(' ', '', rawurldecode("user/profile/" . $image->data()->username)); ?>" ><?php echo $image->data()->user . "&nbsp(" . $image->data()->username . "&nbsp)"; ?></a></p>
                            <!-- Description -->
